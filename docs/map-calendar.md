...
Der Shopping-Button durchsucht die eingesammelten Termine. Eine zusätzliche Auswertung der vorhandenen muenchen.de-Quelle liest die [Shoppingnacht-Übersicht](https://www.muenchen.de/shopping/aktuell/shopping-naechte-und-abendoeffnungen-muenchen) und die [städtische Ladenschlussverordnung](https://stadt.muenchen.de/rathaus/stadtrecht/vorschrift/440/version3/0.html). Der erste Wiesn-Sonntag wird nur aus dem ausdrücklich veröffentlichten [Oktoberfestzeitraum](https://www.muenchen.de/veranstaltungen/oktoberfest) bestimmt. Veröffentlichungsdaten gelten nicht als Veranstaltungstage.

Alle solchen Einträge heißen „Öffnung möglich“ und unterscheiden die Erlaubnis von einer bestätigten Ladenöffnung. Enthalten sind Shoppingnächte (20–24 Uhr), Tourismusbedarf in Altstadt-Fußgängerbereichen und Olympiapark sowie die beschränkten Sonderfälle Faschingssonntag, erster Wiesn-Sonntag und 3. Oktober. Gebiete, Warenbeschränkungen und Ausnahmen stehen in der Beschreibung. Keine vollständige Erfassung aller Ausnahmen: Arena, Tankstellen, Bäckereien und individuell angezeigte Abende werden nicht zu ungeprüften Einzelterminen umgedeutet.

Die Regelberechnung verwendet die am 26.09.2026 geprüften Paragraphen 2, 4, 5, 6 und 8. Vor jeder Verarbeitung werden deren normalisierte Inhalte gegen Prüfsummen kontrolliert; Änderungen erfordern eine erneute fachliche Prüfung. Die eingebundene Version muss bei einer neuen Verordnung aktualisiert werden. Die HTML-Seite der Verordnung verwendet Windows-1252; der HTTP-Client respektiert dafür ausdrücklich erklärte Zeichenkodierungen. Weitere Lese-Ursprünge sind pro Quelle über `additional_origins` freigegeben, mit denselben Robots- und Abrufregeln.

Es gilt weiterhin der 30-Tage-Horizont. Eine erst später liegende Shoppingnacht wird nicht allein wegen des neuen Buttons sofort angezeigt. Flächige Öffnungen ohne konkreten Laden werden nicht auf einen erfundenen Kartenpunkt gesetzt und haben keinen GPX-Export.
